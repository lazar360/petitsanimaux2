...
<form action="" method="POST" enctype="multipart/form-data">
                ...
                <td>
                    <select name="caractere1">
                        <?php foreach($caracteres as $caractere) : ?>
                            ...
                            <?php if(isset($data['animal']['caractere1']) && $data['animal']['caractere1']['id_caractere'] === $caractere['id_caractere'] ) echo "selected"?>>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="localisation" name="localisation" rows="5"><?=  $data['animal']['localisation_description_animal'] ?></textarea>
    </div>
    <div class="form-group">
